        ...
        <div class="bg-neutral-800 rounded-lg p-6 shadow-lg" transition:fly={{y: -30, duration: 1000, delay: 700}}>
          ...
          <div class="flex flex-row-2 ">
              ...
              <p class="text-gray-300 text-sm text-left">
                  ...
                  <br><br>
                  At Carleton, I racked up ~1k in parking tickets and founded the blockchain club, with the help of my friends, I grew it from 0-200 in ~1 semester hosting 6 unforgettable events. 
                  <br><br>
